...
$OpenSSLDestPath = "$Env:Programfiles\Linkja\Win64OpenSSL-1_1_1s.msi"
Get-LinkjaInstaller "OpenSSL" "https://slproweb.com/download/Win64OpenSSL-1_1_1t.msi" $OpenSSLDestPath
