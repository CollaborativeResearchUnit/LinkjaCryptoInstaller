...
$OpenSSLDestPath = "$Env:Programfiles\Linkja\Win64OpenSSL-3_3_2.msi"
Get-LinkjaInstaller "OpenSSL" "https://slproweb.com/download/Win64OpenSSL-3_3_2.msi" $OpenSSLDestPath
